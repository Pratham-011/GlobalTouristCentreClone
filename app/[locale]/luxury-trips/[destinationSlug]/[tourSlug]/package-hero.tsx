...
export function PackageHero({ data }: PackageHeroProps) {
  ...
  return (
    <section className="relative h-[60vh] min-h-[500px] w-full overflow-hidden">
      ...
      {/* Header sits in its own z-layer, above the gradient */}
      <div className="absolute inset-x-0 top-0 z-20">
        <Header />
      </div>

      {/* Content — pt pushes it below the navbar */}
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center container mx-auto px-4 pt-24">
        {/* Premium Badge */}
        <div className="mb-6">
        ...
        {/* CTA */}
        <Link href={ctaLink} target="_blank" rel="noopener noreferrer" className="inline-block">
