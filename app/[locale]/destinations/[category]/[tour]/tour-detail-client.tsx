...
import { TourPrice } from "@/components/tours/tour-price";
import type { TourPriceData } from "@/components/tours/tour-price";
import type {
  ItineraryItem,
  ItineraryTracks,
} from "@/components/tours/tour-itinerary";
...
export default function TourClient({ tourId }: TourClientProps) {
  ...
  const hasPrice = hasPriceBlock(price);
