export const services = {
  "services": {
    "title": "Our Services",
    "subtitle": "We offer a complete range of travel services to ensure your journey is seamless and memorable.",
    "readMore": "Read More",
    "domesticInternational": "Domestic & International Tours",
    "domesticInternationalDesc": "From Goa beaches to international destinations, we curate the best experiences with carefully planned itineraries.",
    "customizedHolidays": "Customized Holiday Packages",
    "customizedHolidaysDesc": "Tailor-made vacations designed to your preferences, budget, and travel style for a truly personal experience.",
    "visaDocumentation": "Visa & Documentation",
    "visaDocumentationDesc": "Comprehensive assistance with visa applications, travel documents, and other formalities for hassle-free travel.",
    "hotelBookings": "Hotel Bookings",
    "hotelBookingsDesc": "Access to the best accommodation options at competitive rates, from luxury resorts to budget stays.",
    "airTicketing": "Air Ticketing",
    "airTicketingDesc": "Domestic and international flight bookings with the best fares and convenient schedules.",
    "groupTours": "Group Tours",
    "groupToursDesc": "Well-organized group tours with expert guides, perfect for families, friends, and corporate groups."
  },
  "servicePages": {
    ...
    "domesticInternational": {
      ...
      "domestic": {
        ...
        "subtitle": "Explore the diverse beauty of India with our handpicked domestic destinations.",
        "viewMore": "View More Domestic Trips"
      },
      "international": {
        "title": "International Trips",
        "subtitle": "Discover exotic destinations around the world with our international tour packages.",
        "viewMore": "View More International Trips"
      },
      "faq": {
        "title": "Frequently Asked Questions",
        "subtitle": "Find answers to common questions about our domestic and international tours.",
        "questions": [
          {
            "question": "What documents do you need from me at the time of booking?",
            "answer": "We will need a valid passport and government-issued identity proof to get the booking started. As per the destination and airline requirements, we may ask for more documentation such as your Aadhaar card or a copy of your travel documents."
          },
          {
            "question": "Do you offer visa assistance or visa processing services?",
            "answer": "Yes, our team will guide through the process, help you with the necessary paperwork and make sure that everything is in order before submission."
          },
          {
            "question": "What is your policy for refunds/compensation in case of service failures (missed hotel nights, cancelled excursions)?",
            "answer": "If a hotel night is missed or an excursion gets cancelled due to service issues, we will step in to sort it out. Depending on the circumstance, you may be offered a refund or travel credit."
          },
          {
            "question": "Should I arrive earlier for international flights than domestic ones?",
            "answer": "For domestic flights, reach the airport 2 hours before. For international flights, arrive 3 to 4 hours early to manage security and immigration without stress."
          }
        ]
      },
      "metadata": {
  ...
  "premiumServices": {
    ...
    "subtitle": "Comprehensive travel services tailored to your needs. From planning to execution.",
    "explore": "",
    "items": {
      "custom": {
